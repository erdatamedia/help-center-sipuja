  ...
  return (
    <div className="relative">
      <input
        ...
        className="w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-white text-gray-900 bg-white dark:bg-gray-700"
